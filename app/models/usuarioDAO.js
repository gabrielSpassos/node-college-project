module.exports = function(application){
    ...
    this.getTUEpDia = function(connectionMysql, idUsuario, idDia, callback) {
    ...
    this.updateUsuarioExercicioByIdTreinoExercioUsuario = function (connectionMysql, idUsuario, id, peso, repeticoes, series, descanso, callback) {
        return connectionMysql.query(`UPDATE treino_usuario_exercicio set peso = '${peso}', repeticoes = '${repeticoes}', series = '${series}', descanso = '${descanso}' where treino_usuario_exercicio.id_dia = '${id}' and 'treino_usuario_exercicio.id_usuario= '${idUsuario}';`, callback);
    };
